...
static const RPC_CLIENT_INTERFACE Server___RpcClientInterface =
    {
...
RPC_IF_HANDLE Server_v1_0_c_ifspec = (RPC_IF_HANDLE)& Server___RpcClientInterface;

extern const MIDL_STUB_DESC Server_StubDesc;

static RPC_BINDING_HANDLE Server__MIDL_AutoBindHandle;
    ...
    /* [in] */ int n)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Server_StubDesc,
                  (PFORMAT_STRING) &Fact__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&n);
...
static const MIDL_STUB_DESC Server_StubDesc = 
    {
    (void *)& Server___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &ServerBinding,
    0,
